1. Make sure you have Java installed and are able to run java files through cmd.
2. Run "run.bat".
...
**This program only works with polynomials in standard form up to x^2 (ax^2 + bx + c = 0)**